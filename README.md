...
Требование по GPU:
- текущий воркер рассчитан на FP8 путь (`CUDA SM 8.9+`), оптимально `H100/H200/L40S`
- путь генерации детерминированный и фиксированный: `FP8 + AOTI` без runtime fallback
