...
## Профиль рантайма
- Текущая конфигурация воркера зафиксирована под FP8-путь (`CUDA SM 8.9+`, рекомендуемо `H100/H200/L40S`).
- Путь инференса детерминированный: фиксированный режим `FP8 + AOTI` и фиксируемый seed по умолчанию (`WAN22_DEFAULT_SEED=42`).
